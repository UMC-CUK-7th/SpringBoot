...
![~~이름 짓기 더럽게 힘드네~~](Chapter%207%20API%20%E1%84%8B%E1%85%B3%E1%86%BC%E1%84%83%E1%85%A1%E1%86%B8%20%E1%84%90%E1%85%A9%E1%86%BC%E1%84%8B%E1%85%B5%E1%86%AF%20&%20%E1%84%8B%E1%85%A6%E1%84%85%E1%85%A5%20%E1%84%92%E1%85%A2%E1%86%AB%E1%84%83%E1%85%B3%E1%86%AF%E1%84%85%E1%85%A5%20(1)%2056b17ff5a1614ca1bd2fa645a42a3cf7/Untitled.png)
...
- RestContollerAdvice
    ...
    : Spring에서 제공하는 어노테이션. 컨트롤러에서 발생하는 예외를 한 곳에서 처리하는 기능을 한다.
    
    - 예외가 발생했을 때 자동으로 JSON 형식으로 응답을 반환
    - 일관된 에러 응답 형식을 제공
...
- 모든 컨트롤러에서 발생하는 예외를 중앙에서 관리할 수 있다.
- 표준화된 에러 응답 제공 : JSON 등
    
    표준화된 형식으로 에러 메시지를 반환할 수 있어 프론트엔드와 백엔드 간의 인터페이스를 일관성 있게 유지할 수 있다.
    
- 각 컨트롤러마다 개별적으로 예외 처리 로직을 작성할 필요가 없어 코드의 중복을 제거할 수 있다.
- 다양한 예외 유형을 한 곳에서 관리할 수 있다.

**없으면 불편한 점**

- 모든 컨트롤러에서 중복된 예외 처리 코드를 작성해야 한다. (try-catch)
- 각각의 컨트롤러에서 반환하는 에러 메시지 포맷이 달라질 수 있다.
    
    → 프론트엔드와의 비효율적 통신
    
- 예외 처리를 개별적으로 해야 하기 때문에 일부 컨트롤러에서 예외 처리를 누락할 가능성이 높아진다.
    
    → 500 Internal Server Error 반환
    
    → 사용자 경험 저하 + 디버깅 어려움
    
- 변경 사항이 발생할 때 일관되게 수정하기 어려워짐
    
    예) 특정 예외에 대한 응답 형식을 변경 → 모든 컨트롤러 수정
...
1. ApiResponse
    ...
    ![image.png](Chapter%207%20API%20%E1%84%8B%E1%85%B3%E1%86%BC%E1%84%83%E1%85%A1%E1%86%B8%20%E1%84%90%E1%85%A9%E1%86%BC%E1%84%8B%E1%85%B5%E1%86%AF%20&%20%E1%84%8B%E1%85%A6%E1%84%85%E1%85%A5%20%E1%84%92%E1%85%A2%E1%86%AB%E1%84%83%E1%85%B3%E1%86%AF%E1%84%85%E1%85%A5%20(1)%2056b17ff5a1614ca1bd2fa645a42a3cf7/image.png)
